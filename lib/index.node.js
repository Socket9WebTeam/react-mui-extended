...
var PageLoader = function PageLoader() {
  ...
  }, react.jsx(material.CircularProgress, null));
};
...
var ButtonLoader = function ButtonLoader(_ref) {
  ...
  }, react.jsx(material.CircularProgress, {
    size: "1em"
  }));
};
...
var ActionButton = function ActionButton(_ref) {
  ...
  return react.jsx(material.Button, _extends({}, props, {
    variant: variant,
    color: color,
    disabled: isLoading !== null && isLoading !== void 0 ? isLoading : disabled
  }), react.jsx(ButtonLoader, {
    isLoading: isLoading
  }), children);
};
...
var MessageBox = function MessageBox(_ref) {
  ...
  return react.jsx("div", {
    ...
    "data-testid": testId
  }, react.jsx(material.Alert, {
    severity: severity,
    action: action
  }, react.jsx(material.AlertTitle, null, title), description));
};
...
var IconWithMenu = function IconWithMenu(_ref) {
  var children = _ref.children,
    ...
    _ref$icon = _ref.icon,
    IconComponent = _ref$icon === void 0 ? iconsMaterial.MoreHoriz : _ref$icon,
    testId = _ref.testId;
  ...
  return (
    ...
    react.jsx(react$1.Fragment, null, react.jsx(material.IconButton, _extends({
      "aria-haspopup": "true",
      ...
      size: "large",
      "data-testid": testId
    }, iconButtonProps), react.jsx(IconComponent, null)), react.jsx(material.Menu, {
      anchorEl: anchorEl,
      keepMounted: false,
      open: !!anchorEl,
      onClose: closeMenu
...
var ConfirmDialog = function ConfirmDialog(_ref) {
  ...
  return react.jsx(material.Dialog, {
    open: isOpen,
    "data-testid": testId,
    maxWidth: "xs"
  }, react.jsx(material.DialogTitle, null, title), react.jsx(material.DialogContent, null, react.jsx(material.DialogContentText, null, description)), react.jsx(material.DialogActions, null, react.jsx(material.Button, {
    color: "secondary",
    onClick: onClickNo,
    "data-testid": buttonNoTestId
  }, buttonNoText), react.jsx(material.Button, {
    onClick: onClickYes,
...
function useConfirmDialogAction() {
  var _useState = react$1.useState(defaultConfirmActionState),
    _useState2 = _slicedToArray(_useState, 2),
    state = _useState2[0],
...
var PageHeader = function PageHeader(_ref) {
  ...
  return react.jsx("div", {
    ...
    css: headerContainer
  }, !!onClickBackButton && react.jsx(material.Button, {
    variant: "text",
    css: backButtonStyle,
    "data-testid": "button.pageHeaderBack",
    onClick: onClickBackButton
  }, react.jsx(iconsMaterial.ArrowBack, null)), react.jsx(material.Typography, {
...
var Snackbar = function Snackbar(_ref) {
  ...
  return react.jsx(material.Snackbar, _extends({}, snackbarProps, {
...
var GlobalSnackbarContext = /*#__PURE__*/react$1.createContext(undefined);
// eslint-disable-next-line max-lines-per-function
var GlobalSnackbarProvider = function GlobalSnackbarProvider(_ref) {
  var children = _ref.children;
  var _useReducer = react$1.useReducer(globalSnackbarReducer, globalSnackbarInitialState),
  ...
  return react.jsx(GlobalSnackbarContext.Provider, {
    value: dispatch
  }, children, react.jsx(Snackbar, _extends({}, snackbarProps !== null && snackbarProps !== void 0 ? snackbarProps : {}, {
...
var useGlobalSnackbar = function useGlobalSnackbar() {
  var dispatch = react$1.useContext(GlobalSnackbarContext);
  if (dispatch === undefined) {
    throw new Error('useGlobalSnackbar() cannot be used outside GlobalSnackbarProvider');
  }
  return react$1.useCallback(function (payload) {
    return dispatch({
      type: 'open',
      payload: payload
    });
...
var PasswordVisibilityIcon = function PasswordVisibilityIcon(_ref) {
  ...
  return react.jsx(material.InputAdornment, {
    position: "end"
  }, react.jsx(material.IconButton, {
    "aria-label": "toggle password visibility",
    "data-testid": "button.passwordVisibility",
    onClick: onClick,
    size: "large"
  }, isVisible ? react.jsx(iconsMaterial.Visibility, {
    "data-testid": "icon.passwordVisible"
  }) : react.jsx(iconsMaterial.VisibilityOff, {
...
var PasswordInput = function PasswordInput(_ref) {
  ...
  return react.jsx(material.TextField, _extends({
    name: "password",
    label: "Password"
  }, props, {
    ...
    InputProps: {
      endAdornment: react.jsx(PasswordVisibilityIcon, {
...
exports.ErrorMessageBox = ErrorMessage;
exports.GlobalSnackbarProvider = GlobalSnackbarProvider;
exports.IconWithMenu = IconWithMenu;
exports.MessageBox = MessageBox;
exports.PageHeader = PageHeader;
exports.PageLoader = PageLoader;
exports.PasswordInput = PasswordInput;
exports.Snackbar = Snackbar;
exports.useConfirmDialogAction = useConfirmDialogAction;
exports.useGlobalSnackbar = useGlobalSnackbar;
